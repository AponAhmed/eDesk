...
<div class="flex flex-col sm:flex-row gap-4">
        <!-- Column 1 -->
        <div class="flex-1 rounded-sm bg-white p-4">
            <strong class="mb-4 block">Hints:</strong>
            <ol>
                <p class="mb-4">
                    <strong>1.</strong> We are a garments supplier in Bangladesh, manufacturing a wide range of clothing for
                    men,
                ...
                <p class="mb-4">
                    <strong>2.</strong> In order to provide you with accurate pricing for the styles you desire, kindly
                    share
                    the
                ...
                <p class="mb-4">
                    <strong>3.</strong> Our general Minimum Order Quantity (MOQ) requirement for adult-size garments,
                ...
                <p class="mb-4"><strong>4.</strong> Our payment terms involve a 30% advance payment upon order placement,
                    another 40% when the
        ...
        <div class="flex-1 rounded-sm bg-white p-4">
            <strong class="mb-4 block">Hints:</strong>
            <p class="mb-4">
                <strong>1.</strong> We are a garments supplier in Bangladesh, manufacturing all sorts of clothing for men,
                women, and
            ...
            <p class="mb-4">
                <strong>2.</strong> To provide you with accurate pricing for the styles you desire, please share the
                following details:
            </p>
            ...
            <p class="mb-4">
                <strong>3.</strong> Our general Minimum Order Quantity (MOQ) requirement for a fabric type is 2000 pieces
                for adult-size
            ...
            <p class="mb-4">
                <strong>4.</strong> Our payment terms include a 30% advance payment upon order placement, another 40% when
                the production
