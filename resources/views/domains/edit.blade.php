<h1 class="text-lg mb-4 border-b border-solid border-slate-200 py-2 dark:border-slate-700 dark:text-gray-300">Edit Domain</h1>
...
<form method="POST" action="{{ route('domains.update', $domain->id) }}" >
    ...
    <br>
    <button type="submit"
        class="button mt-4 px-4 py-2 font-semibold text-sm bg-cyan-500 text-white rounded-md shadow-sm dark:bg-cyan-600 dark:text-gray-200">Update
        Domain</button>
</form>
