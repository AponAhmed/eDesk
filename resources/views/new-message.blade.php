<form method="POST" enctype='multipart/form-data' action="{{ route('sendnew') }}" class="ajx">
    @csrf
    <div class="to-area mb-2 flex items-center">
        <div class="mr-2 w-1/3 rounded-md flex items-center border border-gray-300  bg-white">
        ...
        <div class="w-2/3 flex">
            <input name="toaddress" class="rounded-md" type="text" placeholder="To" required>
        </div>
    </div>
    ...
    <div class="mb-1">
        <div class="to-area mb-2 flex items-center">
            <div class="w-3/8 flex items-center border border-gray-300 rounded-md  bg-white">
            ...
            <div class="w-2/8 flex items-center ml-3">
